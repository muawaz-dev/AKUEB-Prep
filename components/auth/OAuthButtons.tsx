import { signInWithGoogleAction, signInWithFacebookAction } from "@/app/auth/actions";

const buttonClass =
  "flex items-center justify-center gap-2 border border-black/20 dark:border-white/20 rounded px-3 py-2 text-sm font-medium hover:bg-black/5 dark:hover:bg-white/5";
